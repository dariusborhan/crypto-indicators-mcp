...
# requests. That matters for a hosted deployment: the process can be restarted,
# scaled, or woken from idle without breaking an in-flight connection.
mcp = FastMCP("crypto-indicators", stateless_http=True)
